...
Route::group(['middleware' => ['role:librarian']], function () {
    ...
    Route::post('/peminjaman', [BorrowedBookController::class, 'store'])->name('book.store');

    // Page Pengembalian Buku
    Route::get('/pengembalian', [BorrowedBookController::class, 'returning'])->name('book.returning');
    Route::patch('/pengembalian', [BorrowedBookController::class, 'updateToReturn'])->name('book.update');
    ...
    Route::prefix('/book')->group(function () {
        ...
        Route::delete('/{book}/delete', [BookController::class, 'destroy'])->name('book.destroy');
    });
});
